...
class RencanaPengeluaranModel extends Model
{
    ...
    /**
     * Realisasikan rencana: insert ke pengeluarans pakai nominal AKTUAL yang benar-benar
     * dikeluarkan (bukan estimasi rencana). PENTING: jumlah_rencana TIDAK PERNAH diubah — itu
