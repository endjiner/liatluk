    ...
    <div class="flex items-center justify-between h-16 gap-3">
      ...
      <div class="flex items-center gap-1">
        <a href="<?= base_url('perjalanan-dinas') ?>"
           class="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition <?= str_contains(current_url(), 'perjalanan-dinas') ? 'text-primary-700 dark:text-primary-300 bg-primary-50 dark:bg-primary-900/30' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' ?>">
